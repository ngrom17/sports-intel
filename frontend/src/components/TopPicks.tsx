...
import PickDetailModal, { contractLabel } from "./PickDetailModal";
...
export default function TopPicks({ rows, sport }: { rows: PredictionRow[]; sport: string }) {
      ...
      <div className="section">
        ...
        <div className="picks-grid">
          {picks.map((r) => (
            <div
              key={r.ticker}
              className="pick-card pick-card-clickable"
            ...
            >
              ...
              <div className="pick-card-contract">{contractLabel(r)}</div>
              ...
              <div className="pick-card-hint">Click for breakdown →</div>
            </div>
          ))}
        </div>
      </div>
